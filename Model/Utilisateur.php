...
class Utilisateur
{
    ...
    public function __construct(string $nom, string $prenom, string $email, string $mot_de_passe, string $telephone = '', string $sexe = '', string $date_naissance = '', string $adresse = '', string $role = 'candidat', string $statut = 'inactif')
    {
        $this->nom            = $nom;
        $this->prenom         = $prenom;
        $this->email          = $email;
    ...
    public function setDateNaissance(string $date_naissance): void { $this->date_naissance = $date_naissance; }
