...
// Suppress errors from displaying
error_reporting(E_ALL);
ini_set('display_errors', 0);

$entretiens = $entretiens ?? [];
$stats = $stats ?? ['total' => 0, 'a_venir' => 0, 'termines' => 0, 'annules' => 0];
$typesEntretien = $typesEntretien ?? [];
$statuts = $statuts ?? [];
$statsByPoste = $statsByPoste ?? [];
?>
<!doctype html>
<html
  lang="fr"
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="./gestion-entretiens.php" class="app-brand-link">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <?php if (!empty($statsByPoste)): ?>
                <div class="row mb-4">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h5 class="card-title mb-0">Graphique des postes</h5>
                      </div>
                      <div class="card-body">
                        <div id="chart-postes" data-postes='<?= htmlspecialchars(json_encode($statsByPoste), ENT_QUOTES, "UTF-8") ?>' style="height: 280px;"></div>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
                      ...
                      <div class="col-md-3">
                        <select name="sort" class="form-select" onchange="this.form.submit()">
                          <option value="">Tri candidat</option>
                          <option value="candidat_asc" <?= (isset($_GET['sort']) && $_GET['sort'] === 'candidat_asc') ? 'selected' : '' ?>>Nom A-Z</option>
                          <option value="candidat_desc" <?= (isset($_GET['sort']) && $_GET['sort'] === 'candidat_desc') ? 'selected' : '' ?>>Nom Z-A</option>
                        </select>
                      </div>
                      <div class="col-md-3 d-flex align-items-center justify-content-end gap-2">
                        <?php if (!empty($_GET['type_entretien_id']) || !empty($_GET['statut']) || !empty($_GET['sort'])): ?>
                        ...
                        <?php
                          $exportQuery = [];
                          if (!empty($_GET['type_entretien_id'])) $exportQuery['type_entretien_id'] = $_GET['type_entretien_id'];
                          if (!empty($_GET['statut'])) $exportQuery['statut'] = $_GET['statut'];
                          if (!empty($_GET['sort'])) $exportQuery['sort'] = $_GET['sort'];
                          $exportQuery['action'] = 'print';
                        ?>
                        <a href="./gestion-entretiens.php?<?= htmlspecialchars(http_build_query($exportQuery)) ?>" target="_blank" class="btn btn-outline-primary btn-sm">
                          <i class="bx bx-download me-1"></i>Exporter PDF
                        </a>
                      </div>
                    </div>
                  </form>
                      ...
                      <div class="col-md-10 offset-md-2">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column gap-3">
                          <div class="dt-buttons btn-group flex-wrap">
                            <a href="/Hilux-1.0.0/Hilux-1.0.0/View/entretien/add.php" class="btn btn-primary">
                              <span><i class="bx bx-plus me-0 me-sm-1 bx-sm"></i><span class="d-none d-sm-inline-block">Ajouter</span></span>
                            </a>
                          </div>
                        </div>
                      </div>
    ...
    <script src="./assets/js/entretiens-chart.js"></script>
