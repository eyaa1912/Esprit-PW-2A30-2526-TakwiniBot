...
<head>
    ...
    <title>Créer un entretien | Takwini</title>
            ...
            <div class="layout-page">
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Créer un entretien</h4>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="gestion-entretiens.php?action=create">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="genre" class="form-select" required>
                                                    ...
                                                    <?php foreach ($genres as $g): ?>
                                                        <option value="<?= htmlspecialchars($g) ?>"><?= ucfirst($g) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="poste_cible" class="form-control" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Type de handicap</label>
                                                <input type="text" name="type_handicap" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Aménagements</label>
                                                <input type="text" name="amenagements" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Métier suggéré</label>
                                                <input type="text" name="metier_suggere" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Score RSE (1-5)</label>
                                                <input type="number" name="score_rse" class="form-control" min="1" max="5">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="statut" class="form-select" required>
                                                    <?php foreach ($statuts as $s): ?>
                                                        <option value="<?= htmlspecialchars($s) ?>" <?= $s === 'planifié' ? 'selected' : '' ?>><?= ucfirst($s) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
