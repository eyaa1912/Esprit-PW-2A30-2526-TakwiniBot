...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $stmt = $pdo->prepare('INSERT INTO entretien
            (nom_candidat, email_candidat, genre, type_handicap, amenagements, type_entretien_id,
             date_entretien, heure_entretien, poste_cible, metier_suggere, score_rse, remarques, statut)
            VALUES
            (:nom_candidat, :email_candidat, :genre, :type_handicap, :amenagements, :type_entretien_id,
             :date_entretien, :heure_entretien, :poste_cible, :metier_suggere, :score_rse, :remarques, :statut)');
        ...
        $_SESSION['flash_success'] = 'Entretien ajouté avec succès.';
                    ...
                    <form method="post" action="create.php">
                        ...
                        <div id="handicap-fields" style="display:none;">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="type_handicap" name="type_handicap" class="form-control" value="<?= e($data['type_handicap']) ?>" data-hint="Précisez votre type de handicap">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="number" id="score_rse" name="score_rse" min="1" max="5" class="form-control" value="<?= e($data['score_rse']) ?>">
...
<?php include 'View/entretien/_avatar_assistant.php'; ?>
...
<script src="View/entretien/avatar_assistant.js"></script>
<script>
(function () {
