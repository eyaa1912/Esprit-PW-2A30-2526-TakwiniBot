              ...
              <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <li class="nav-item dropdown me-2 me-xl-1">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item logout-btn" href="javascript:void(0);" data-app-lang="fr">Français</a></li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      ...
                      if (!empty($__av)) {
                          $__navAvatar = (strpos($__av, 'assets/img/avatars/') !== false) ? '../' . $__av : '../../../../../view/frontoffice/' . $__av;
                      } else {
                    ...
                    <li>
                      <a class="dropdown-item" href="mon-profil.php">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <h6 class="mb-0"><?php echo htmlspecialchars($_SESSION['user']['nom'] ?? 'Admin'); ?></h6>
