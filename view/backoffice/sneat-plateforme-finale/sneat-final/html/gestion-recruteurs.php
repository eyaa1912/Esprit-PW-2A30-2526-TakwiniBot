    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item"><a href="/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/view/frontoffice/formations/index.php" class="menu-link" target="_blank"><i class="menu-icon tf-icons bx bx-globe"></i><div class="text-truncate">Voir le site</div></a></li>
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Workflow info -->
                    <div class="alert mb-4" style="background:#e8f4fd;border-left:4px solid #0ea5e9;color:#0c4a6e;">
                        <div class="d-flex align-items-start gap-2">
                            <i class="bx bx-info-circle mt-1" style="font-size:18px;color:#0ea5e9;flex-shrink:0;"></i>
                            <div>
                                <strong>Workflow de vérification matricule fiscal</strong><br>
                                <span style="font-size:13px;">
                                    1. Cliquez <strong>"Vérifier RNE"</strong> — le matricule est copié automatiquement dans votre presse-papier et le site RNE s'ouvre.<br>
                                    2. Collez le matricule (<kbd>Ctrl+V</kbd>) dans la barre de recherche du RNE et vérifiez l'entreprise.<br>
                                    3. Cliquez <strong>"Valider"</strong> ou <strong>"Rejeter"</strong> selon le résultat.
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><code><?= htmlspecialchars($r['matricule_fiscal'] ?? '-') ?></code></td>
