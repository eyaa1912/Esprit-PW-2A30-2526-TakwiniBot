        ...
        if (empty($email) || empty($password)) {
            ...
            if ($result['success']) {
                ...
                if ($result['user']['role'] === 'admin') {
                    ...
                    header('Location: /Esprit-PW-2A30-2627-TakwiniBot-gestion_formation/Esprit-PW-2A30-2627-TakwiniBot-gestion_formation/gestion_formation/View/front_office/formations/index.php');
                }
                exit;
            } else {
