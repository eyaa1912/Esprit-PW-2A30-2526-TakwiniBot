...
try {
    ...
    $redirect = $bestMatch['role'] === 'admin'
        ? '/gestion_utilisateur_v5/gestion_utilisateur1/view/backoffice/sneat-plateforme-finale/sneat-final/html/index.php'
        : '/gestion_utilisateur_v5/gestion_utilisateur1/view/frontoffice/formations/index.php';
