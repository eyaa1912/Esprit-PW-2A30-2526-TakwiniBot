...
<body data-spy="scroll" data-offset="80">
	...
	$loginUrl  = '/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/view/frontoffice/login.php';
	$logoutUrl = '/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/controller/logout.php';
	?>
	<style>
	...
	<nav class="tk-nav">
		<div class="tk-nav-inner">
			...
			<ul class="tk-links">
				...
				<?php if ($role === 'admin'): ?>
				<li>
					<a href="/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/view/backoffice/sneat-plateforme-finale/sneat-final/html/index.php"
				...
				<li class="tk-user-wrap">
					...
					<div class="tk-dropdown">
						...
						<a href="/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/Esprit-PW-2A30-2627-TakwiniBot-gestion_user/view/frontoffice/formations/index.php?logout=1" class="logout" id="btn-logout">Deconnexion</a>
					</div>
				</li>
				<?php else: ?>
