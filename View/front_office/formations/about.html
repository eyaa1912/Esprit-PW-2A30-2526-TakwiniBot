...
<body data-spy="scroll" data-offset="80">
				...
				<div class="col-12 col-md-10 d-none d-xl-block">
					<nav class="site-navigation position-relative text-right" role="navigation">
						<ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
							...
							<li><a class="nav-link" href="file:///C:/Users/AMEN/Desktop/offres-emploi.html">Offres</a></li>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-12 col-xs-12">
					<div class="about-us-content">
						<h2>Plateforme web tunisienne dÃ©diÃ©e Ã  l'emploi des personnes en situation de handicap.</h2>
						<p>Connecte intelligemment les candidats handicapÃ©s aux entreprises inclusives.</p>
						<p><strong>FonctionnalitÃ©s clÃ©s :</strong></p>
						<ul>
							<li><i class="fa fa-check"></i>Moteur de matching IA adaptÃ© aux besoins spÃ©cifiques</li>
							<li><i class="fa fa-check"></i>Coaching CV automatique</li>
							<li><i class="fa fa-check"></i>Score RSE + critÃ¨res d'accessibilitÃ© (lieu de travail, tÃ©lÃ©travail, amÃ©nagements)</li>
						</ul>
					</div>
				</div><!-- END COL -->
				<div class="col-lg-6 col-sm-12 col-xs-12">
	...
	<section data-stellar-background-ratio="0.3" class="about_video"
		style="background-image: url(assets/img/bg/video-bg.jpg); background-size:cover; background-position: center center;">
		<div class="container">
			<div class="row">
