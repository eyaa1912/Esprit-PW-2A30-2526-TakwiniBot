...
(function () {
  ...
  function getControllerUrl(action) {
    if (window.location.protocol === 'file:') {
      return 'http://localhost/Esprit-PW-2A30-2627-TakwiniBot-gestion_reclamation/Controller/ReclamationController.php?action=' + encodeURIComponent(action);
    }
    var basePath = window.location.pathname.split('/View/')[0];
    if (!basePath) {
      basePath = '/Esprit-PW-2A30-2627-TakwiniBot-gestion_reclamation';
    }
    return window.location.origin + basePath + '/Controller/ReclamationController.php?action=' + encodeURIComponent(action);
  }
