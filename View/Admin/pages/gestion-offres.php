              ...
              <div class="card">
                <div class="card-header border-bottom">
                  ...
                  <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
                    <div class="col-md-4">
                      <select class="form-select text-capitalize"><option value="">Sélectionner Entreprise</option><option value="TechAccess">TechAccess</option><option value="Solidarité Pro">Solidarité Pro</option></select>
                    </div>
                    <div class="col-md-4">
                      <select class="form-select text-capitalize"><option value="">Sélectionner Type</option><option value="CDI">CDI</option><option value="CDD">CDD</option><option value="Stage">Stage</option></select>
                    </div>
                    <div class="col-md-4">
                      <select class="form-select text-capitalize"><option value="">Sélectionner Statut</option><option value="Publiée">Publiée</option><option value="Brouillon">Brouillon</option><option value="Archivée">Archivée</option></select>
                    </div>
                  </div>
                </div>
...
document.getElementById("offreForm").addEventListener("submit", function(e) {
    ...
    if (titre.length < 3) errors.push("Titre trop court (min 3 caractères)");
    if (desc.length < 10) errors.push("Description trop courte (min 10 caractères)");
